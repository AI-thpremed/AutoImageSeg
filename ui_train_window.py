...
class Ui_TrainWindow(object):
    ...
    def retranslateUi(self, TrainWindow):
        ...
        self.combo_algo.setItemText(3, QCoreApplication.translate("TrainWindow", u"UNet", None))
        self.combo_algo.setItemText(4, QCoreApplication.translate("TrainWindow", u"UNext", None))
        self.combo_algo.setItemText(5, QCoreApplication.translate("TrainWindow", u"AttU_Net", None))
        self.combo_algo.setItemText(6, QCoreApplication.translate("TrainWindow", u"NestedUNet", None))
        self.combo_algo.setItemText(7, QCoreApplication.translate("TrainWindow", u"UNetResnet", None))
        self.combo_algo.setItemText(8, QCoreApplication.translate("TrainWindow", u"FCN", None))

...
class Ui_TrainWindowMask(object):
    ...
    def retranslateUi(self, TrainWindowMask):
        ...
        self.combo_algo.setItemText(3, QCoreApplication.translate("TrainWindowMask", u"UNet_Base", None))
        self.combo_algo.setItemText(4, QCoreApplication.translate("TrainWindowMask", u"UNet_Medium", None))
        self.combo_algo.setItemText(5, QCoreApplication.translate("TrainWindowMask", u"UNet_Small", None))
        self.combo_algo.setItemText(6, QCoreApplication.translate("TrainWindowMask", u"UNet_Tiny", None))
        self.combo_algo.setItemText(7, QCoreApplication.translate("TrainWindowMask", u"UNext", None))
        self.combo_algo.setItemText(8, QCoreApplication.translate("TrainWindowMask", u"AttU_Net", None))
        self.combo_algo.setItemText(9, QCoreApplication.translate("TrainWindowMask", u"NestedUNet", None))
        self.combo_algo.setItemText(10, QCoreApplication.translate("TrainWindowMask", u"UNetResnet", None))
        self.combo_algo.setItemText(11, QCoreApplication.translate("TrainWindowMask", u"FCN", None))
